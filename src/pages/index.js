...
import gsap, { TweenMax, Power4, TimelineMax } from "gsap"
...
const IndexPage = () => {
  ...
  useEffect(() => {
    ...
    tl.from(
      "#heading-one",
      0.5,
      { y: 100, ease: Power4.ease, delay: 0.5 },
      "text"
    )
    tl.from(
      "#heading-two",
      0.5,
      { y: 100, ease: Power4.ease, delay: 0.6 },
      "text"
    )
    tl.from(
      "#heading-three",
      0.5,
      { y: 100, ease: Power4.ease, delay: 0.7 },
      "text"
    )
    tl.from(
      "#heading-four",
      0.5,
      { y: 100, ease: Power4.ease, delay: 0.8 },
      "text"
    )
    tl.from(
      "#heading-five",
    ...
    tl.from(
      "#buttons",
      0.7,
      { y: 50, ease: Power4.ease, delay: 1.5, opacity: 0 },
      "text"
    )
    ...
    headingTimeline.from("#subheading", {
      y: 50,
      ease: Power4.ease,
      opacity: 0,
    })
    ...
    const paraTimeline = new gsap.timeline({ paused: true })

    paraTimeline.from("#para-design", {
      y: 30,
      ease: Power4.ease,
      opacity: 0,
      delay: 0.5,
          ...
          <Row className="navigation__row">
            <Col className="navigation__column">
                ...
                <div className="navigation__logo--wrapper">
                  ...
                  >
                    <g fill="none" fill-rule="evenodd">
                      ...
                      <path
                        fill="#FEEEB7"
                        d="M47.903 48l-28.5 30.666h57"
                      ></path>
                    </g>
                  </svg>
                </div>
                <div id="text" className="navigation__item--left">
                  Extensions
                </div>
              ...
              <div className="navigation__menu--right">
                <div className="navigation__item--right">
                  Try for free &darr;
                </div>
        ...
        <Container>
          <Row>
            <Col className="header__column">
              ...
              <span className="header__heading-wrapper">
                <span className="header__item--wrapper">
                  <span className="header__heading" id="heading-one">
                    The
                  </span>
                </span>
                <span className="header__item--wrapper">
                  <span className="header__heading" id="heading-two">
                    best
                  </span>
                </span>
                <span className="header__item--wrapper">
                  <span className="header__heading" id="heading-three">
                    products
                  </span>
                </span>
                <span className="header__item--wrapper">
                  <span className="header__heading" id="heading-four">
                    start
                  </span>
                </span>
                <span className="header__item--wrapper">
                  <span className="header__heading" id="heading-five">
                    with
                  </span>
                </span>
                <span className="header__item--wrapper">
                  <span className="header__heading" id="heading-six">
                    Sketch
                  </span>
                </span>
              </span>
            ...
            <Col className="design__column">
              ...
              <div ref={designContent} className="design__content">
                ...
                <div id="designcard-two" className="design__sub-container">
                  ...
                  <div className="text">
                    Sketch’s interface automatically adapts to show you the
                    tools you need, and gets out of the way when you need to
                    focus.
                  </div>
                </div>
                <div
                ...
                <div id="designcard-four" className="design__sub-container">
                  ...
                  <div className="text">
                    Test your assumptions and turn static designs into
                ...
                <div id="designcard-five" className="design__sub-container">
                  ...
                  <div className="text">
                    Stress-test your designs with real, diverse data sets that
                ...
                <div id="designcard-six" className="design__sub-container">
                  ...
                  <div className="text">
                    From buttons, to menus, to cards and beyond, with Smart
                    Layout your components can resize automatically to fit their
                    content.
                  </div>
                </div>
              </div>
              ...
              <div className="customize__content">
                ...
                >
                  ...
                  <div className="customize__text-wrapper">
                    <h3>Runner</h3>
                    <div className="text">
                      Speed up your workflow with quicker access to all your
                      tools and actions in Sketch.
                    </div>
                    <div className="customize__badge">Plugin</div>
                  </div>
                </div>
                ...
                <div id="customize-card-six" className="customize__card">
                  ...
                  <div className="customize__text-wrapper">
                    <h3>React Sketch</h3>
                    <div className="text">
                      Render React components to Sketch and build a design
                      system.
                    </div>
                    <div className="customize__badge">Plugin</div>
                  </div>
              ...
              <div className="pricing__content">
                ...
                <div className="pricing__text-wrapper">
                  ...
                  <span className="pricing__text">
                    Turn your ideas into incredible products with a 30 day
                    trial.
                  </span>
                </div>
